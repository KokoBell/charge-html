...
navBar.setAttribute('class',  `${location.pathname === '/contact.html' ? 'brownBackground' : ''}`)

// Nav links
let elementShadow = `${location.pathname === '/contact.html' ? 'darkShadow' : 'lightShadow'}`
let navCss = 'navLink ' + elementShadow
...
charge_logo.setAttribute('href', 'index.html')

charge_logo.setAttribute('class', navCss)

charge_logo.innerHTML = '<img alt="Logo for the Charge ice-cream sales website." src="assets/charge_logo.png" height="32" />'
...
contactUs.setAttribute('class', navCss)
...
shop.setAttribute('href', 'shop.html')

shop.setAttribute('class', navCss)
...
aboutUs.setAttribute('href', 'about.html')

aboutUs.setAttribute('class', navCss)
...
shopIcon.setAttribute('href', 'shop.html')

shopIcon.setAttribute('class', 'navLink darkShadow icon')
...
login.setAttribute('class', 'navLink darkShadow login')
